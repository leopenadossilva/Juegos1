...
const PLATFORMS: Array[Rect2] = [
	Rect2(-320, 0, 640, 32),
	Rect2(-352, -1750, 32, 1750),
	Rect2(320, -1750, 32, 1750),
	Rect2(-150, -100, 100, 16),
	Rect2(50, -220, 100, 16),
	Rect2(-200, -340, 100, 16),
	Rect2(100, -470, 120, 16),
	Rect2(-280, -600, 100, 16),
	Rect2(160, -740, 120, 16),
	Rect2(-200, -880, 120, 16),
	Rect2(80, -1040, 120, 16),
	Rect2(-280, -1220, 120, 16),
	Rect2(120, -1420, 160, 16),
	Rect2(-280, -1650, 180, 16),
]
